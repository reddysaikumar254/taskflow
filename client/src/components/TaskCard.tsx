        ...
        >
          <Card 
            className={cn(
              ...
              snapshot.isDragging ? "shadow-lg scale-105 rotate-2 ring-2 ring-primary/20 z-50" : "shadow-sm",
            ...
            <CardHeader className="p-4 pb-2 space-y-0 flex flex-row items-start justify-between">
              <div className="space-y-1 w-full">
                <div className="flex items-center justify-between">
                  <Badge 
                    variant="outline" 
                    className={cn("text-[10px] px-2 py-0.5 font-medium border", priorityColors[task.priority])}
                  >
                    {task.priority}
                  </Badge>
                  <Button
